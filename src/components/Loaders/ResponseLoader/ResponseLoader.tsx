    ...
    >
      ...
      <clipPath id="sand-mound-bottom">
        <path
          ...
          className={styles.sandMoundBottom}
        />
      </clipPath>
      <g transform="translate(2,2)">
        ...
        >
          ...
          <circle
            ...
            cx={26}
            strokeWidth={1}
            className={styles.motionThin}
          />
        </g>

        <g transform="translate(13.75,9.25)" className={styles.model}>
          <path
          ...
          <g strokeLinecap="round" stroke="hsl(35,90%,90%)">
            <line
              ...
              strokeWidth={1}
              className={styles.sandGrainLeft}
            />
            <line
              y2={21.75}
              x2={12.5}
              ...
              strokeDasharray="0.25 33.75"
              strokeWidth={1}
              className={styles.sandGrainRight}
            />
            <line
              y2={31.5}
              x2={12.25}
            ...
            <line
              ...
              strokeWidth={1}
              stroke="hsl(35,90%,83%)"
              className={styles.sandLineRight}
            />
          ...
          <g strokeWidth={2} strokeLinecap="round" opacity={0.7} fill="none">
            <path
              ...
              stroke="hsl(0,0%,100%)"
              className={styles.glareTop}
            />
            <path
              transform="rotate(180,12.25,16.75)"
              d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5"
              stroke="hsla(0,0%,100%,0)"
              className={styles.glareBottom}
            />
          </g>
